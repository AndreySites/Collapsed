...
var questions = [
    ...
    [["We should reopen some software companies.", "A.I.", "Fine", "No", 2101, 51], [0, 5, 0, 10], [0, 0, 0, -5]],
    ...
    [["We should use code-generating software instead of human developers.", "A.I.", "Of course!", "No", 2101, 51], [0, -5, 0, 10], [0, 5, 0, 0]],
    ...
    [["A plane crashed near capital! Survivors need help urgently.", "Walker, Investigation Agent", "I will send it", "They're fine", 2070, 2], [0, 5, 0, -5], [0, -5, 0, 0]],
    ...
    [["Somebody take control over hospital computers, invest more in cybersecurity.", "A.I.", "Yes", "Shut up!", 2101, 51], [0, 0, 5, -5], [0, -10, -10, 0]],
    ...
    [["Computer viruses are everywhere. We need better protection.", "A.I.", "Alright", "Bye.", 2101, 51], [0, 5, 5, -5], [0, -5, -10, 0]],
    [["RED WARNING: The national database is corrupted!", "A.I.", "Fix it", "Does it matter?", 2101, 51], [0, 0, 5, 0], [0, 0, -10, -10]],
    ...
    [["Our researchers needs more funds. Instead, we can create a new weapon.", "Scott, Scientist", "Alright", "No way!", 2070, 2], [0, 0, 10, -5], [0, -5, -5, 5]],
    ...
    [["Our country internet is slow. We need new technology!", "A.I.", "Scientist will do!", "It's fast enough", 2101, 51], [0, 5, 5, -5], [0, -5, 0, 0]]
];
...
var info = [
    ...
    [["Somebody attacked us with atomic bombs. We don't know who did this, radiation level is increasing!", "Mann, Army General"], ["What?!", 2], ["Terrible!", 2], [4, 1, 2105, 302]],
    [["Radioactivity affects environment, this may be the full end.", "default"], ["...", 0], ["...", 0], [4, 2, 2105, 302]],
    [["A war is iminent. I'm afraid the single thing we can do is to fight!", "Jackson, Vice President"], ["Oh no...", 2], ["Bad", 2], [5, 1, 2121, 235]],
    [["Load the bullets, start the tanks, defend the country!", "default"], ["...", 0], ["...", 0], [5, 2, 2121, 235]],
    [["A virus escaped from laboratories! I'm afraid that we started a pandemic.", "Scott, Scientist"], ["Ahh!", 2], ["Awful!", 2], [6, 1, 2143, 12]],
    [["As soon as the first human was infected, your country and world is in danger.", "default"], ["...", 0], ["...", 0], [6, 2, 2143, 12]]
];
...
function choose(){
    ...
    setTimeout(function(){text.style.opacity = 1;}, 200);

    //choose the question
    let questionNumber = getRandomInt(0, questions.length - 1);
    let textData;

    //check if year and day is valid for that question
