    ...
    setTimeout(function(){
        ...
        if(environment >= 0 && happiness >= 0 && army >= 0 && money >= 0 && environment <= 50 && happiness <= 50 && army <= 50 && money <= 50)
        {
            ...
            if(year >= questions[questionNumber][0][4] && day >= questions[questionNumber][0][5]){
                ...
                //show result
                text.textContent = textData + " money: " + money.toString() + " env: " + environment.toString() + " army: " + army.toString() + " happiness: " + happiness.toString();
...
//optionOne function
function opOne(){
    if(environment > 0 && happiness > 0 && army > 0 && money > 0){
